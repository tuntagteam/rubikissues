...
def main(root):
    ...
    #COLOUR SELECTOR
    selectors = [
        Button(colourSel,width=6,height=2,bg=cols[0],command=lambda:selected_colour(mode,0),text="Green"),
        Button(colourSel,width=6,height=2,bg=cols[1],command=lambda:selected_colour(mode,1),text="Blue"),
        Button(colourSel,width=6,height=2,bg=cols[2],command=lambda:selected_colour(mode,2),text="White"),
        Button(colourSel,width=6,height=2,bg=cols[3],command=lambda:selected_colour(mode,3),text="Yellow"),
        Button(colourSel,width=6,height=2,bg=cols[4],command=lambda:selected_colour(mode,4),text="Red"),
        Button(colourSel,width=6,height=2,bg=cols[5],command=lambda:selected_colour(mode,5),text="Orange"),
    ]
